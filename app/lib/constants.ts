...
export const projects = [
  ...
  },
  {
    ...
    name: "Weather App",
    type: "Web App",
    image: "/images/weatherappMockup.png",
    technologies: ["HTML", "CCS", "JavaScript"],
    url: `${githubPages}weather_app`,
    github: `${github}weather_app`,
    description: `Users can fetch the current weather with the information of Humidity, Wind, and Sea level.`,
  },
    {
    name: "Calculator",
    type: "Web App",
    image: "/images/simpleCalculatorMockup.webp",
    technologies: ["React", "Tailwind", "TypeScript", "Next.js", "Framer motion"],
  ...
  },
  {
    ...
    image: "/images/idsgadgetsMockup.png",
    technologies: ["React", "Tailwind", "TypeScript", "Next.js"],
    url: `${githubPages}iDSGadgets`,
    github: `${github}iDSGadgets`,
    description: `Bridge the gap between creativity and productivity with the most powerful VR-ready machines`,
  },
  {
    name: "Artoku",
    type: "Website landing page",
    image: "/images/artokuMockup.png",
    technologies: ["React", "Tailwind", "TypeScript", "Next.js"],
    url: `${githubPages}Artoku_Landing_page`,
    github: `${github}Artoku_Landing_page`,
    description: `Artoku landing page. We manage assets and money from investors, we have many financial planners for the development of your assets..`,
  },
  {
    id: 12,
    name: "Day Counter",
