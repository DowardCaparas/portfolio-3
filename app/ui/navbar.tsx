...
const NavBar = () => {
  ...
  return (
    <nav className="fixed top-0 z-10 right-0 left-0 ">
      <div
        className="ring-2 ring-[#3F3F3F] bg-[#0A0A0A] p-3 mx-auto 
    space-x-2 col-span-3 flex justify-center"
      >
        {navLinks.map((link, index) => (
          <div key={link.label} className="flex gap-2 items-center">
            ...
            transition duration-150 ease-out max-md:flex-col
              ${
                pathname === link.url
